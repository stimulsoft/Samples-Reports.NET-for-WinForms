...
namespace Reports
{
    ...
    public class MultiColumnBandsAcrossThenDown : Stimulsoft.Report.StiReport
    {
        ...
        {
            e.Value = (Line).ToString() + "." + (Customers.CompanyName).ToString();
        }
        ...
        public void InitializeComponent()
        {
            ...
            this.ReportAlias = "Multi Column Bands, Across then Down";
            // 
            // ReportChanged
            // 
            this.ReportChanged = new System.DateTime(2005, 11, 17, 2, 52, 0, 0);
            // 
            // ReportCreated
            // 
            ...
            this.ReportTitleBand1.ClientRectangle = new Stimulsoft.Base.Drawing.RectangleD(0, 0.4, 19, 3);
            ...
            this.Text5.ClientRectangle = new Stimulsoft.Base.Drawing.RectangleD(0, 0, 19, 3);
            ...
            this.ColumnHeaderBand1.ClientRectangle = new Stimulsoft.Base.Drawing.RectangleD(0, 4.2, 19, 0.6);
            this.ColumnHeaderBand1.DockStyle = StiDockStyle.Top;
            ...
            this.DataBand1.ColumnGaps = 0.5;
            this.DataBand1.Columns = 3;
            this.DataBand1.ColumnWidth = 6;
            this.DataBand1.CountData = 2;
            ...
            this.Text1.ClientRectangle = new Stimulsoft.Base.Drawing.RectangleD(0, 0, 6, 0.6);
            ...
            this.ColumnHeaderBand1.Page = Page1;
            this.ColumnHeaderBand1.Parent = Page1;
            this.Text10.Page = Page1;
            this.Text10.Parent = ColumnHeaderBand1;
