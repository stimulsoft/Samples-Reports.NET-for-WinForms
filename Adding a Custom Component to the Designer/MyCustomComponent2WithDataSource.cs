...
{
	[StiServiceBitmap(typeof(MyCustomComponent2WithDataSource), "Adding_a_Custom_Component_to_the_Designer.MyCustomComponent5.gif")]
	[StiToolbox(true)]
	...
	public class MyCustomComponent2WithDataSource : StiComponent, IStiBorder, IStiBrush, IStiDataSource
	{
		...
		#region this
		/// <summary>
		/// Creates a new component of the type MyCustomComponent2WithDataSource.
		/// </summary>
		public MyCustomComponent2WithDataSource() : this(RectangleD.Empty)
		{
		}
		...
		public MyCustomComponent2WithDataSource(RectangleD rect) : base(rect)
		{
			PlaceOnToolbox = true;
		}
		#endregion
